  ...
  return (
    <div className="tw-w-full tw-flex tw-justify-between tw-p-2 ">
        ...
        <div className='tw-flex tw-gap-5 tw-justify-end tw-my-auto'>
            <button className="tw-px-[45px] tw-flex tw-py-[15px] tw-rounded-xl tw-bg-[#001EB9] tw-text-white tw-my-auto">New Product</button>
            <button style={{ border : '1px solid rgba(0, 30, 185,0.7)' }} className="tw-px-[5px] tw-flex tw-my-auto tw-bg-white tw-border-[1px]">
